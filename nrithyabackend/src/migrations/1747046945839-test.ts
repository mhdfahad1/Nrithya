...
export class Test1747046945839 implements MigrationInterface {
    name = 'Test1747046945839'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "created_at" SET DEFAULT '"2025-05-12T10:49:10.148Z"'`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "updated_at" SET DEFAULT '"2025-05-12T10:49:10.148Z"'`);
        await queryRunner.query(`ALTER TABLE "courses" ALTER COLUMN "created_at" SET DEFAULT '"2025-05-12T10:49:10.176Z"'`);
        await queryRunner.query(`ALTER TABLE "courses" ALTER COLUMN "updated_at" SET DEFAULT '"2025-05-12T10:49:10.176Z"'`);
        await queryRunner.query(`ALTER TABLE "teachers" ALTER COLUMN "created_at" SET DEFAULT '"2025-05-12T10:49:10.236Z"'`);
        await queryRunner.query(`ALTER TABLE "teachers" ALTER COLUMN "updated_at" SET DEFAULT '"2025-05-12T10:49:10.236Z"'`);
        await queryRunner.query(`ALTER TABLE "batches" ALTER COLUMN "created_at" SET DEFAULT '"2025-05-12T10:49:10.337Z"'`);
        await queryRunner.query(`ALTER TABLE "batches" ALTER COLUMN "updated_at" SET DEFAULT '"2025-05-12T10:49:10.337Z"'`);
        await queryRunner.query(`ALTER TABLE "students" ALTER COLUMN "created_at" SET DEFAULT '"2025-05-12T10:49:10.437Z"'`);
        await queryRunner.query(`ALTER TABLE "students" ALTER COLUMN "updated_at" SET DEFAULT '"2025-05-12T10:49:10.437Z"'`);
        ...
        await queryRunner.query(`ALTER TABLE "assignments" ALTER COLUMN "created_at" SET DEFAULT '"2025-05-12T10:49:10.810Z"'`);
        await queryRunner.query(`ALTER TABLE "assignments" ALTER COLUMN "updated_at" SET DEFAULT '"2025-05-12T10:49:10.810Z"'`);
        await queryRunner.query(`ALTER TABLE "bank_detail" ALTER COLUMN "updated_at" SET DEFAULT '"2025-05-12T10:49:10.922Z"'`);
        await queryRunner.query(`ALTER TABLE "compensation_batch_history" ALTER COLUMN "created_at" SET DEFAULT '"2025-05-12T10:49:10.977Z"'`);
        await queryRunner.query(`ALTER TABLE "compensation_batch_history" ALTER COLUMN "updated_at" SET DEFAULT '"2025-05-12T10:49:10.977Z"'`);
        await queryRunner.query(`ALTER TABLE "compensation_student_history" ALTER COLUMN "created_at" SET DEFAULT '"2025-05-12T10:49:11.006Z"'`);
        await queryRunner.query(`ALTER TABLE "compensation_student_history" ALTER COLUMN "updated_at" SET DEFAULT '"2025-05-12T10:49:11.006Z"'`);
        await queryRunner.query(`ALTER TABLE "enquiry_type" ALTER COLUMN "created_at" SET DEFAULT '"2025-05-12T10:49:11.142Z"'`);
        await queryRunner.query(`ALTER TABLE "enquiry_type" ALTER COLUMN "updated_at" SET DEFAULT '"2025-05-12T10:49:11.142Z"'`);
        await queryRunner.query(`ALTER TABLE "audit_log" ALTER COLUMN "date" SET DEFAULT '"2025-05-12T10:49:11.183Z"'`);
        await queryRunner.query(`ALTER TABLE "batch_activity" ALTER COLUMN "created_at" SET DEFAULT '"2025-05-12T10:49:11.229Z"'`);
        await queryRunner.query(`ALTER TABLE "batch_activity" ALTER COLUMN "updated_at" SET DEFAULT '"2025-05-12T10:49:11.229Z"'`);
    }
